...
import edu.mum.paymentservice.dto.PaymentResponse;
...
public class PaymentServiceController {
    ...
    @PostMapping("/payment/methods/make/{key}")
       public String makePayment(@PathVariable String key , @RequestBody String reqApiKey){
...
//        paymentDetails.setPaymentFor("Order Id : " + order.getId() );
            ...
            return "Invalid API Key : Unauthorize Request";
        }
    }
